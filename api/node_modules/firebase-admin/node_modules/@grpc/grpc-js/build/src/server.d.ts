import { Deserialize, Serialize, ServiceDefinition } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/make-client';
import { HandleCall } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/server-call';
import { ServerCredentials } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/server-credentials';
import { ChannelOptions } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/channel-options';
import { ServerRef } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/channelz';
