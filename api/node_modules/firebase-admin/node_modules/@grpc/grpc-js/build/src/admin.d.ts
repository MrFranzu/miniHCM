import { ServiceDefinition } from "firebase-admin/node_modules/@grpc/grpc-js/build/src/make-client";
import { Server, UntypedServiceImplementation } from "firebase-admin/node_modules/@grpc/grpc-js/build/src/server";
