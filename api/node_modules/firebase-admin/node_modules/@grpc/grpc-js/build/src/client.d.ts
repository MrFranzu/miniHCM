...
import { ClientDuplexStream, ClientReadableStream, ClientUnaryCall, ClientWritableStream, ServiceError, SurfaceCall } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/call';
import { CallCredentials } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/call-credentials';
import { Channel } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/channel';
import { ChannelCredentials } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/channel-credentials';
import { ChannelOptions } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/channel-options';
import { Metadata } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/metadata';
import { ClientMethodDefinition } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/make-client';
import { Interceptor, InterceptorProvider } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/client-interceptors';
import { ServerUnaryCall, ServerReadableStream, ServerWritableStream, ServerDuplexStream } from 'firebase-admin/node_modules/@grpc/grpc-js/build/src/server-call';
